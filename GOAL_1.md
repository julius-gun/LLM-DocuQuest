...
The manual being used can be downloaded [here](https://www.kvgportal.com/W_global/Media/lexcom/VN/A14870/A148703540-2.pdf).
...
*   **[PDF Question and Answer Generator using Google Gemini API](/1%20Evaluate%20Machine-Readable%20Formats%20for%20LLMs/1.0%20Generate%20Questions/question-answer_generator_for_pdf_documents_Gemini.py)**
    ...
    * The Google Gemini API, utilizing the **Gemini Experimental 1206** model, demonstrated superior performance. However, automatic question generation was followed by a stringent manual review. Ultimately, more than 75% of the generated questions and answers were discarded to maintain quality standards.
    * The resulting pairs can be seen [here](/1%20Evaluate%20Machine-Readable%20Formats%20for%20LLMs/question_answer_pairs.json).
